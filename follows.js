(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'aCtwtPPzvv8Xz6kXr2pEcsQ0lKNRfDKdNcORY2ozpy48Up5G', // Unique master Xively API key to be used as a default
		defaultFeeds	= [88833,94208,91743], // Comma separated array of Xively Feed ID numbers
...
// Build Graph
									var graph = new Rickshaw.Graph( {
										...
										max: 1.25*(parseFloat(datastream.max_value)),
										padding: {
											top: 0.02,
											right: 0.02,
											bottom: 0.02,
